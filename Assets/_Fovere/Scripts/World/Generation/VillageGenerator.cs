...
namespace Fovere
{
    ...
    public class VillageGenerator : Generator
    {
        ...
        public override void Generate(World world)
        {
            ...
            Debug.Log("Terrain generated, time elapsed in millis: " +
                      (DateTimeOffset.Now.ToUnixTimeMilliseconds() - milliseconds));
            Debug.Log("Chunks rebuilt async, time elapsed in millis: " +
                      (DateTimeOffset.Now.ToUnixTimeMilliseconds() - milliseconds));
        ...
        {
            var y = (int)(Mathf.PerlinNoise((x + _seed) / PerlinScale, (z + _seed) / PerlinScale) * HeightScale) +
                    WorldHeight;
