...
namespace Fovere
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            // Player Loading
            if (transmitter.HasPlayerTransferData() &&
                DataHelpers.ValidateKeys(transmitter.RetrieveTransferredPlayer(), PlayerStructure))
            {
            ...
            // REMOVE WORLD LOADING FOR NOW, we will use a unity model for the prototype and polish the world generation futher down the line.
            // World Loading
            /*
        ...
        private void OnWorldLoad()
        {
            ...
            var residentHandler = spawnedResident.GetComponent<PrototypeResidentHandler>();
